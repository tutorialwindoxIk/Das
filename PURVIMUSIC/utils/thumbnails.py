...
async def get_thumb(videoid):
    ...
    try:
        ...
        font_size = 40
        font = ImageFont.truetype("PURVIMUSIC/assets/font2.ttf", font_size)
        font2_size = 70
        font2 = ImageFont.truetype("PURVIMUSIC/assets/font2.ttf", font2_size)
        arial = ImageFont.truetype("PURVIMUSIC/assets/font2.ttf", 30)
        name_font = ImageFont.truetype("PURVIMUSIC/assets/font.ttf", 40)
